  ...
  <div>
    ...
    <p>
      ...
      <a
          ...
          target="_blank"
          class="text-patreon hover:text-white"
      >
        <svg
      ...
      or buy me a
      <a href="https://ko-fi.com/trickfoxx" target="_blank" class="text-kofi hover:text-white">
    ...
    <p class="mt-8 mb-4">
      Copyright &copy; {{ new Date().getFullYear() }} Steven Lloyd. All rights
      reserved
    </p>
  </div>
</template>
