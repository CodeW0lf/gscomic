<template>
  <div>
    <div class="mt-8 text-center group">
      ...
      >
        <svg class="fill-current text-bsky hover:text-bsky-lighter inline-block w-4 h-4 mx-1"
             role="img"
             width="24"
             height="24"
             viewBox="0 0 600 530"
    ...
    <div class="mt-4 mx-auto text-center">
      ...
      >
        <svg
            class="fill-current text-telegram hover:text-telegram-lighter inline-block w-8 h-8 mx-2"
            role="img"
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
        >
          <title>Telegram Join @ComicSlayers</title>
          <path
      ...
      <a
          ...
          class="bksy"
      >
        <svg class="fill-current text-bsky hover:text-bsky-lighter inline-block w-8 h-8 mx-2"
             role="img"
             width="24"
             height="24"
             viewBox="0 0 600 530"
      ...
      <a
          href="https://discord.gg/HKZmH3U"
          @click="discordClick"
          target="_blank"
      >
        <svg
            class="fill-current text-discord hover:text-discord-lighter inline-block w-8 h-8 mx-2"
            role="img"
            viewBox="0 0 24 24"
            xmlns="http://www.w3.org/2000/svg"
        >
...
export default {
  ...
  methods: {
    ...
    bskyClick() {
      // eslint-disable-next-line no-undef
      gtag('event', 'Bluesky', {event_category: 'Social'})
    },
    telegramClick() {
      // eslint-disable-next-line no-undef
  ...
  computed: {
    shareUrl() {
      let message = encodeURIComponent(
        `Check out God Slayers Comic (@trickfoxx.bsky.social)!\nhttps://www.godslayerscomic.com${this.$route.path}`
      )
      return (
        'https://bsky.app/intent/compose?text=' + message
      )
    },
    voteImgRollover() {
